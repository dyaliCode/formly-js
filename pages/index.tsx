      ...
      <div className="bg-slate-800 dark:bg-transparent grid h-screen place-items-center">
        <div className="container mx-auto flex flex-col items-center py-12 sm:py-24">
          <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
            ...
            <span className=" text-indigo-700 block mt-10 text-center sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl">
          ...
          <div className="flex justify-center items-center gap-10">
            <a
              ...
              title="Solid Formly"
              className="shadow-lg shadow-sky-700/50 w-40 h-40 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-solid-700 bg-solid transition duration-150 ease-in-out hover:bg-sky-600 rounded-full text-white px-4 sm:px-10 border border-sky-700 py-2 sm:py-4"
            >
              <img
            ...
            <a
              ...
              title="Svelte Formly"
              className="shadow-lg shadow-orange-700/50 w-40 h-40 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-700 bg-orange-700 transition duration-150 ease-in-out hover:bg-orange-600 lg:text-xl lg:font-bold  rounded-full text-white px-4 sm:px-10 border border-orange-700 py-2 sm:py-4 text-sm"
            >
              <img
                className="w-full h-auto z-10"
                alt="SolidJS"
